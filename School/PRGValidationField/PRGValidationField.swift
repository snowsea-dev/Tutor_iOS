...
enum ValidationMode: Int {
    ...
    case name = 0, email, password, confirmPassword, phoneNumber
    ...
    func validate(_ text: String, passToConfirm: String?) -> Bool? {
        ...
        case .password:
            return text.characters.count >= 4 && text.characters.count <= 10
        case .confirmPassword:
            return passToConfirm != nil && passToConfirm == text
        case .phoneNumber:
            return Validation.isValidPhoneNumber(value: text)
            }
    }
